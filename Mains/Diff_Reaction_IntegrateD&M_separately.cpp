...
#pragma omp parallel for
            ...
            if (D_psi == 0.1)
            {
                sprintf(file_name, "/Users/aliheydari/Documents/Prions Project Data/Diff_ForPlot_D01/cell_splitting_%d.vtk", n);
                
            }
            
            else if ( D_psi == 0.01)
            {
                sprintf(file_name, "/Users/aliheydari/Documents/Prions Project Data/Diff_ForPlot_D001/cell_splitting_%d.vtk", n);
                
            }
            
            else if ( D_psi == 0.001)
            {
                sprintf(file_name, "/Users/aliheydari/Documents/Prions Project Data/Diff_ForPlot_D0001/cell_splitting_%d.vtk", n);
                
            }
            
            else if ( D_psi == 0.0001)
            {
                sprintf(file_name, "/Users/aliheydari/Documents/Prions Project Data/Diff_ForPlot_D00001/cell_splitting_%d.vtk", n);
