...
public:
    ...
    double operator() (double x, double y, double z) const
    {
        ...
        {
            phi2 = sqrt(SQR(x-x2_start)+SQR(y-(y1_start*(1+0.15*4.2)))+SQR(z-z2_start))-(r2_start+alpha2*(t));
...
int main()
{
    ...
    //if we set omp_set_dynamic(true) then it will automatically set number of threads
    // recommended to choose number of threads mannually however!
...
#pragma omp parallel for
    ...
    ofstream filestream("/home/aliheydari/Prions_Mass/total_psi_data_diffOnly/A_DiffRXN_ForPlot_D01.txt");
    ofstream filestream2("/home/aliheydari/Prions_Mass/total_zeta_data_diffOnly/B_DiffRXN_ForPlot_D01.txt");
    ofstream daughterStreamA("/home/aliheydari/Prions_Mass/total_daughter_data_diffOnly/A_DiffRXN_DauOnly_D01.txt");
    ofstream daughterStreamB("/home/aliheydari/Prions_Mass/total_daughter_data_diffOnly/B_DiffRXN_DauOnly_D01.txt");
    ofstream motherStreamA("/home/aliheydari/Prions_Mass/total_mother_data_diffOnly/A_DiffRXN_MothOnly_D01.txt");
    ofstream motherStreamB("/home/aliheydari/Prions_Mass/total_mother_data_diffOnly/B_DiffRXN_MothOnly_D01.txt");
...
#pragma omp parallel for
        ...
        if (D_psi == 0.1)
        {
            sprintf(file_name, "/home/aliheydari/Prions_Output/Diffusion_Gaussian_01/cell_splitting_%d.vtk", n);
            
        }
        
        else if ( D_psi == 0.01)
        {
            sprintf(file_name, "/home/aliheydari/Prions_Output/Diffusion_Gaussian_001/cell_splitting_%d.vtk", n);
            
        }
        
        else if ( D_psi == 0.001)
        {
            sprintf(file_name, "/home/aliheydari/Prions_Output/Diffusion_Gaussian_0001/cell_splitting_%d.vtk", n);
            
        }
        
        else if ( D_psi == 0.0001)
        {
            sprintf(file_name, "/home/aliheydari/Prions_Output/Diffusion_Gaussian_00001/cell_splitting_%d.vtk", n);
