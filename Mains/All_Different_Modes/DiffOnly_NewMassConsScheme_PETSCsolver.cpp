...
//            }
            ...
            // No rescaling needed if our mass conservation scheme works
...
//            cout << "Corrected Total zeta -> "<< total_zeta << endl;
            ...
            if (gamma_AtoB == 0.0)
            {
                sprintf(file_name, "/Users/aliheydari/Documents/Prions Project Data/CenterObj_DiffOnly/cell_splitting_%d.vtk", n);
