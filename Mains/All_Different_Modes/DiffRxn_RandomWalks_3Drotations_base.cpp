...
//                      phi5 = sqrt(SQR((x-x1_ell)/a1) +SQR((y-(y1_ell))/b1) + SQR((z-(z1_ell))/c1))-0.015;
                 ...
                 auto [xx_1,xy_1,xz_1,yx_2,yy_2,yz_2,zx_3,zy_3,zz_3] = Rotation_Const(theta2,omega2,rho2);
...
//                                 SQR((z-(z2_ell+(1*(z_dir2))))/c1))-0.02;
                     ...
                     phi6 = sqrt(SQR(((x-(x2_ell+(x_dir2)))*xx_1 + (y-(y2_ell+(y_dir2)))*xy_1 + (z-(z2_ell+(z_dir2)))*xz_1)/a1)

                                  +SQR(((x-(x2_ell+(x_dir2)))*yx_2 + (y-(y2_ell+(y_dir2)))*yy_2 + (z-(z2_ell+(z_dir2)))*yz_2)/b1)

                                  +SQR(((x-(x2_ell+(x_dir2)))*zx_3 + (y-(y2_ell+(y_dir2)))*zy_3 + (z-(z2_ell+(z_dir2)))*zz_3)/c1))-0.02;
