...
// System parameters
double D_psi = 0.1; // Diffusion coeffcient for "healthy" protein
...
public:
    ...
    double operator() (double x, double y, double z) const
    {
        ...
        double phi2 = sqrt(SQR(x-x2_start)+SQR(y-(y2_start*(1+0.35*t)))+SQR(z-z2_start))-(r2_start+alpha2*t); //daughter
...
public:
    ...
    double operator() (double x, double y, double z) const
    {
        ...
        if (phi>0.)
            ...
            return ((ABS(sqrt(SQR(x-x1_start)+SQR(y-y1_start)+SQR(z-z1_start))-(r1_start)))); //this is where we make it a circle
    }
} psi_initial;
...
#pragma omp parallel for
    ...
    // print to the file for figures
        ofstream filestream("/Users/aliheydari/Documents/Prions Project Data/total_psi_data_diffOnly/psi_out.txt");
        ofstream filestream2("//Users/aliheydari/Documents/Prions Project Data/total_zeta_data_diffOnly/zeta_out.txt");
...
#pragma omp parallel for
        ...
        // print everything
        sprintf(file_name, "/Users/aliheydari/Documents/Prions Project Data/vtk_diffusion_Only/cell_splitting_%d.vtk", n);
