...
public:
    ...
    double operator() (double x, double y, double z) const
    {
        ...
        if (phi>0.)
            ...
            return ((ABS(1000 * exp(-1 * 100 * (SQR(x-x1_start)+SQR(y-y1_start)+SQR(z-z1_start))))));
    }
} psi_initial;
...
public:
    ...
    double operator() (double x, double y, double z) const
    {
        ...
        if (phi>0.)
            ...
            return ((ABS(1000 * exp(-1 * 100 * (SQR(x-x1_start)+SQR(y-y1_start)+SQR(z-z1_start)))))); // Gaussian Distribution
...
#pragma omp parallel for
    ...
    // print to the file for figures
        ofstream filestream("/Users/aliheydari/Documents/Prions Project Data/total_psi_data_diffOnly/psi_DC_G_z001.txt");
        ofstream filestream2("//Users/aliheydari/Documents/Prions Project Data/total_zeta_data_diffOnly/zeta_DC_G_z001.txt");
...
#pragma omp parallel for
        ...
        // print everything
        sprintf(file_name, "/Users/aliheydari/Documents/Prions Project Data/DC_G_z001/cell_splitting_%d.vtk", n);
