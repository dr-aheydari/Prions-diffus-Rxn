...
public:
    ...
    double operator() (double x, double y, double z) const
    {
        ...
        double r2_start = 0.05+ (0.01 * t); //another radius
...
#pragma omp parallel for
    ...
    // print to the file for figures
        ofstream filestream("/Users/aliheydari/Documents/Prions Project Data/total_psi_data_diffOnly/psi_DGrowing.txt");
        ofstream filestream2("//Users/aliheydari/Documents/Prions Project Data/total_zeta_data_diffOnly/zeta_DaughterGrowing.txt");
...
#pragma omp parallel for
        ...
        // print everything
        sprintf(file_name, "/Users/aliheydari/Documents/Prions Project Data/DaughterCenter_Growing/cell_splitting_%d.vtk", n);
