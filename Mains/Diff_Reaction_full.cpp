...
double initial_pop = 10;
double conversion_rate1 = 0;
double mu = 0.2 * 0;
//double D_z = 0.001;
...
#pragma omp parallel for
    ...
    // print to the file for figures
        ofstream filestream("/Users/aliheydari/Documents/Prions Project Data/total_psi_data_diffOnly/psi_Diff_React_2.txt");
        ofstream filestream2("//Users/aliheydari/Documents/Prions Project Data/total_zeta_data_diffOnly/zeta_Diff_React_2.txt");
...
//        poisson_solver.set_Diagonal_Increment(1.0);
        ...
        //#pragma omp parallel for
                ...
                {
                    // rhs
                    zeta_updated(i) = zeta_n(i) + (dt*conversion_rate1*(psi_n(i))*(psi_n(i))) ; // DIFUSION with gamma=0-> zeta_n(i) - 2*gamma_var * zeta_nm1(i); // (alpha - beta*(psi_n(i))*(psi_n(i)) + gamma_var * zeta_m(i));//2 * gamma_var * zeta_m(i))
...
#pragma omp parallel for
        ...
        // print everything
        sprintf(file_name, "/Users/aliheydari/Documents/Prions Project Data/Diff_React_psiToZ/cell_splitting_%d.vtk", n);
