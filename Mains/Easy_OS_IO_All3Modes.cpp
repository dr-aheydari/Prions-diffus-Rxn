...
double D_zeta = 0.09; // Diffusion coeffcient for aggregate

//rate
double gamma_AtoB = 0.05 ;
double initial_pop = 10*0;
double gamma_BtoA = 0.2;
double mu = 0.2 * 0;
//double D_z = 0.001;
...
class LS : public CF_3
{
    ...
    double operator() (double x, double y, double z) const
    {
        ...
        double phi3 = sqrt(SQR(x-xL/3)+SQR(y-yL/5)+SQR(z-zL/4))-(r1_start/2.79329608939);
...
/* ************************************ */
  ...
  if (hole == 'T')
  {
      string Dpsi = "Dpsi_" + to_string(D_psi);
      string gammaAB = "_gAB_" + to_string(gamma_AtoB);

      string folder = Dpsi + gammaAB;
      string PATH = "/Users/aliheydari/Box Sync/Prion Simulations/DiffRxn/";
...
//      NAME = FullPath;
      ...
      string txtPathA = PATH + "TotalMassData/" + folder + "_forA.txt";
      string txtPathB = PATH + "TotalMassData/" + folder + "_forB.txt";
  ...
  {
      string Dpsi = "Dpsi_" + to_string(D_psi);
      string Dzeta = "_Dzeta_" + to_string(gamma_AtoB);

      string folder = Dpsi + Dzeta;
      string PATH = "/Users/aliheydari/Box Sync/Prion Simulations/DiffRxn/";
